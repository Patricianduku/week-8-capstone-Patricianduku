  ...
  <footer className="w-full bg-primary-800 dark:bg-gray-950 text-white pt-6 pb-4 mt-8 md:pt-12 md:pb-8 md:mt-16 px-4 shadow-lg">
    <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-start gap-8">
      ...
      <div className="flex flex-col md:flex-row gap-6 w-full md:w-auto justify-center md:justify-end items-center md:items-start">
        ...
        {/* Newsletter Signup */}
        <form className="mb-4 md:mb-0 flex flex-col items-center md:items-start w-full max-w-xs" onSubmit={e => e.preventDefault()} aria-label="Newsletter Signup">
          <label htmlFor="newsletter" className="font-semibold mb-2 text-lg">Newsletter</label>
          <div className="flex w-full">
            <input id="newsletter" type="email" placeholder="Your email" className="w-full px-3 py-2 rounded-l-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary-400" aria-label="Email address" />
